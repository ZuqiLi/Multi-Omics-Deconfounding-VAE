...
import sys
sys.path.append("./")
from models.hardCoded.adversarial_XAE_multipleAdvNet import advNet, XAE_preTrg, XAE_w_advNet_pingpong
...
## Name of the folder
outname = "adversarialTrg/artificialConfounder/advTraining_AE_multinet"
