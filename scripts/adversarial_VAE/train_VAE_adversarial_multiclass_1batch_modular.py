...
import sys
sys.path.append("./")
from models.adversarial_XVAE_multiclass_modular import advNet, XVAE, XVAE_adversarial_1batch_multiclass
from Data.preprocess import ConcatDataset, scale
from models.clustering import *
from models.func import reconAcc_pearsonCorr, reconAcc_relativeError

''' 
scGAN inspired strategy
'''
...
labels_onehot = [f"artificial{i}" for i in range(num_conf_clf)] 
...
## Name of the folder
outname = "adversarialTrg/modularTest/1batch"
...
for epochs in epochs_ae_w_advNet:
    model_xvae_adv = XVAE_adversarial_1batch_multiclass(PATH_xvae_ckpt=ckpt_xvae_file,
...
model = XVAE_adversarial_1batch_multiclass.load_from_checkpoint(ckpt_file)
...
labels_onehot = ['Confounder1','Confounder2', 'Confounder3', 'Confounder4', 'Confounder5', 'Confounder6']
