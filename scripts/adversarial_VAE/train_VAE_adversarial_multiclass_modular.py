...
import sys
sys.path.append("./")
from models.adversarial_XVAE_multiclass_modular import advNet, XVAE, XVAE_adversarial_multiclass
...
## Name of the folder
outname = "adversarialTrg/modularTest/multiclass"
ls = 50
