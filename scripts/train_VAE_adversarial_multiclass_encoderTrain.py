...
import sys
sys.path.append("./")
from models.adversarial_XVAE_multiclass_encoderTrain import advNet, XVAE_preTrg, XVAE_scGAN
...
for epochs in epochs_ae_w_advNet:
    model_xvae_adv = XVAE_scGAN(PATH_xvae_ckpt=ckpt_xvae_file,
