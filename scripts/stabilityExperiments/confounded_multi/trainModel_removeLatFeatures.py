...
##             Training procedure              ##
#################################################
modelname = 'confounded_multi/XVAE'
maxEpochs = 150
...
pd.DataFrame(res).to_csv(f"lightning_logs/{modelname}/epoch{maxEpochs}/results_performance_removeLatFeatures_pvalueCutoff.csv", index=False)
