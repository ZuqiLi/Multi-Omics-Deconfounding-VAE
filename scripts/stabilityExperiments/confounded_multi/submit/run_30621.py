...
np.random.seed(30621)
torch.manual_seed(30621)
L.seed_everything(30621, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_30621"
ls = 50
