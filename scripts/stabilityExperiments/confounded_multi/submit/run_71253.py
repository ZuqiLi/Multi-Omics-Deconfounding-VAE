...
np.random.seed(71253)
torch.manual_seed(71253)
L.seed_everything(71253, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_71253"
ls = 50
