...
np.random.seed(25687)
torch.manual_seed(25687)
L.seed_everything(25687, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_25687"
ls = 50
