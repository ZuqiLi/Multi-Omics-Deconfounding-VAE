...
np.random.seed(49597)
torch.manual_seed(49597)
L.seed_everything(49597, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_49597"
ls = 50
