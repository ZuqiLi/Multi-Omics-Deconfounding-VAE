...
np.random.seed(76257)
torch.manual_seed(76257)
L.seed_everything(76257, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_76257"
ls = 50
