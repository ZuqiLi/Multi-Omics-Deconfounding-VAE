...
np.random.seed(85546)
torch.manual_seed(85546)
L.seed_everything(85546, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_85546"
ls = 50
