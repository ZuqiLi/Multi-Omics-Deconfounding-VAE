...
np.random.seed(70394)
torch.manual_seed(70394)
L.seed_everything(70394, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_70394"
ls = 50
