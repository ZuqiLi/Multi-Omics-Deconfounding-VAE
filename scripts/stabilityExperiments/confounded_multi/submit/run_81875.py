...
np.random.seed(81875)
torch.manual_seed(81875)
L.seed_everything(81875, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_81875"
ls = 50
