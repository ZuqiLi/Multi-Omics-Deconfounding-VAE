...
np.random.seed(71987)
torch.manual_seed(71987)
L.seed_everything(71987, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_71987"
ls = 50
