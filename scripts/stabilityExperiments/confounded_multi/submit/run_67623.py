...
np.random.seed(67623)
torch.manual_seed(67623)
L.seed_everything(67623, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_67623"
ls = 50
