...
np.random.seed(31138)
torch.manual_seed(31138)
L.seed_everything(31138, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_31138"
ls = 50
