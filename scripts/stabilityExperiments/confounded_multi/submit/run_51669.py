...
np.random.seed(51669)
torch.manual_seed(51669)
L.seed_everything(51669, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_51669"
ls = 50
