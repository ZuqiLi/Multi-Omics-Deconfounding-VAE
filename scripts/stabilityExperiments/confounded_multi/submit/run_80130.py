...
np.random.seed(80130)
torch.manual_seed(80130)
L.seed_everything(80130, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_80130"
ls = 50
