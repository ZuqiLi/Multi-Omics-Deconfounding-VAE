...
np.random.seed(65027)
torch.manual_seed(65027)
L.seed_everything(65027, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_65027"
ls = 50
