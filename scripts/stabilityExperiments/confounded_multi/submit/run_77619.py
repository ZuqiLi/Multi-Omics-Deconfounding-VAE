...
np.random.seed(77619)
torch.manual_seed(77619)
L.seed_everything(77619, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_77619"
ls = 50
