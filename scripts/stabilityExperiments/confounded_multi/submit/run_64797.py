...
np.random.seed(64797)
torch.manual_seed(64797)
L.seed_everything(64797, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_64797"
ls = 50
