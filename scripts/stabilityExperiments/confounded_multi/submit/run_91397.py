...
np.random.seed(91397)
torch.manual_seed(91397)
L.seed_everything(91397, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_91397"
ls = 50
