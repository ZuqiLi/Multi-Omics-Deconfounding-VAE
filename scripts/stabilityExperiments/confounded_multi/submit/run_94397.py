...
np.random.seed(94397)
torch.manual_seed(94397)
L.seed_everything(94397, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_94397"
ls = 50
