...
np.random.seed(69457)
torch.manual_seed(69457)
L.seed_everything(69457, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_69457"
ls = 50
