...
np.random.seed(23133)
torch.manual_seed(23133)
L.seed_everything(23133, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_23133"
ls = 50
