...
np.random.seed(55699)
torch.manual_seed(55699)
L.seed_everything(55699, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_55699"
ls = 50
