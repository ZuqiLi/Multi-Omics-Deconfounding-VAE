...
np.random.seed(88272)
torch.manual_seed(88272)
L.seed_everything(88272, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_88272"
ls = 50
