...
np.random.seed(66926)
torch.manual_seed(66926)
L.seed_everything(66926, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_66926"
ls = 50
