...
from models.adversarial_XVAE_multiclass_pytorch2 import XVAE, advNet, XVAE_adversarial_multiclass

''' Set seeds for replicability  -Ensure that all operations are deterministic on GPU (if used) for reproducibility '''
np.random.seed(78444)
torch.manual_seed(78444)
L.seed_everything(78444, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_78444"
ls = 50
