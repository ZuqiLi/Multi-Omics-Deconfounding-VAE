...
np.random.seed(68748)
torch.manual_seed(68748)
L.seed_everything(68748, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_multi/stability/XVAE_adversarial_multiclass/run_68748"
ls = 50
