...
from models.adversarial_XVAE_multiclass import XVAE, advNet, ARG_MODELTYPE ##XVAE_adversarial_multiclass
...
##             Training procedure              ##
#################################################
modelname = "ARG_OUTPUTNAME" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50

## pretrainig epochs
epochs_preTrg_ae = 2        #10
epochs_preTrg_advNet = 2    #10

## adversarial training epochs
epochs_ae_w_advNet = 2
