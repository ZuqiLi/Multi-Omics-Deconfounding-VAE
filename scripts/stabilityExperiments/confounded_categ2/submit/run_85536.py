...
np.random.seed(85536)
torch.manual_seed(85536)
L.seed_everything(85536, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_85536" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
