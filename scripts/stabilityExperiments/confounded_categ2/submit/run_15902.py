...
np.random.seed(15902)
torch.manual_seed(15902)
L.seed_everything(15902, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_15902" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
