...
np.random.seed(54912)
torch.manual_seed(54912)
L.seed_everything(54912, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_54912" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
