...
np.random.seed(19776)
torch.manual_seed(19776)
L.seed_everything(19776, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_19776" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
