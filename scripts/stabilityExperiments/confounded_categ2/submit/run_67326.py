...
np.random.seed(67326)
torch.manual_seed(67326)
L.seed_everything(67326, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_67326" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
