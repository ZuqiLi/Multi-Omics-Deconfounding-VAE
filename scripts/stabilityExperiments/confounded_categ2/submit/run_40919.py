...
np.random.seed(40919)
torch.manual_seed(40919)
L.seed_everything(40919, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_40919" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
