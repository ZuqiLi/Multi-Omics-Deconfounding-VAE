...
np.random.seed(60563)
torch.manual_seed(60563)
L.seed_everything(60563, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_60563" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
