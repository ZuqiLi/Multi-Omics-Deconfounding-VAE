...
np.random.seed(30946)
torch.manual_seed(30946)
L.seed_everything(30946, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_30946" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
