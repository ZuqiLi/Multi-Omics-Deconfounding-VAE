...
np.random.seed(97400)
torch.manual_seed(97400)
L.seed_everything(97400, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_97400" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
