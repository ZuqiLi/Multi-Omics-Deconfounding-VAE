...
np.random.seed(87978)
torch.manual_seed(87978)
L.seed_everything(87978, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_87978" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
