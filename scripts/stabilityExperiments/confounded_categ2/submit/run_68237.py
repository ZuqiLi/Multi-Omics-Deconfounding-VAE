...
np.random.seed(68237)
torch.manual_seed(68237)
L.seed_everything(68237, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_68237" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
