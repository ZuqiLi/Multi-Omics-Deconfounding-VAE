...
np.random.seed(69123)
torch.manual_seed(69123)
L.seed_everything(69123, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_69123" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
