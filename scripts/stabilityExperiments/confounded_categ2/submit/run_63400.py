...
np.random.seed(63400)
torch.manual_seed(63400)
L.seed_everything(63400, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_63400" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
