...
np.random.seed(65435)
torch.manual_seed(65435)
L.seed_everything(65435, workers=True)
...
conf_type = 'categ'
conf = np.loadtxt(os.path.join(PATH_data, "TCGA",'TCGA_confounder_categ2.csv'), delimiter=",")
...
modelname = 'confounded_categ2/stability/cutoff_corr_05/run_65435'
maxEpochs = 150
