...
np.random.seed(3587)
torch.manual_seed(3587)
L.seed_everything(3587, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_3587" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
