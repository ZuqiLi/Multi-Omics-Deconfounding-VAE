...
np.random.seed(16692)
torch.manual_seed(16692)
L.seed_everything(16692, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ2/stability/XVAE_scGAN_multiclass/run_16692" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
