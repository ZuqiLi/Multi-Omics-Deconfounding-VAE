...
np.random.seed(87157)
torch.manual_seed(87157)
L.seed_everything(87157, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_87157" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
