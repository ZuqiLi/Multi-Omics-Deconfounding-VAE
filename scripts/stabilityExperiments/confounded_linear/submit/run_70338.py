...
np.random.seed(70338)
torch.manual_seed(70338)
L.seed_everything(70338, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_70338" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
