...
np.random.seed(92585)
torch.manual_seed(92585)
L.seed_everything(92585, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_92585" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
