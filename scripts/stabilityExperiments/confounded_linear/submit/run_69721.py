...
np.random.seed(69721)
torch.manual_seed(69721)
L.seed_everything(69721, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_69721" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
