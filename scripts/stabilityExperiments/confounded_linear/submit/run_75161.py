...
np.random.seed(75161)
torch.manual_seed(75161)
L.seed_everything(75161, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_75161" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
