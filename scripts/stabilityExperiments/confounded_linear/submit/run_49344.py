...
np.random.seed(49344)
torch.manual_seed(49344)
L.seed_everything(49344, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_49344" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
