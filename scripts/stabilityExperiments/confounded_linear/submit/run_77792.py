...
np.random.seed(77792)
torch.manual_seed(77792)
L.seed_everything(77792, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_77792" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
