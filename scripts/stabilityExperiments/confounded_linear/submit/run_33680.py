...
np.random.seed(33680)
torch.manual_seed(33680)
L.seed_everything(33680, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_33680" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
