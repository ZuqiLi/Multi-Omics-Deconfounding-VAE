...
np.random.seed(7290)
torch.manual_seed(7290)
L.seed_everything(7290, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_7290" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
