...
np.random.seed(91501)
torch.manual_seed(91501)
L.seed_everything(91501, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_91501" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
