...
np.random.seed(49389)
torch.manual_seed(49389)
L.seed_everything(49389, workers=True)
...
##             Training procedure              ##
#################################################
modelname = 'confounded_linear/stability/corrSq/run_49389'
maxEpochs = 150
...
for i in range(50):
    ...
    for epoch in [1, maxEpochs]:
        ...
        model = XVAE_corrReg.load_from_checkpoint(ckpt_file)
