...
np.random.seed(29762)
torch.manual_seed(29762)
L.seed_everything(29762, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_29762" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
