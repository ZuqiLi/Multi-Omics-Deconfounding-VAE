...
np.random.seed(92207)
torch.manual_seed(92207)
L.seed_everything(92207, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_92207" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
