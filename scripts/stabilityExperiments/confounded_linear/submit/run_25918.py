...
np.random.seed(25918)
torch.manual_seed(25918)
L.seed_everything(25918, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_25918" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
