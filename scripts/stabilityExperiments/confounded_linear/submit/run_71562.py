...
np.random.seed(71562)
torch.manual_seed(71562)
L.seed_everything(71562, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_71562" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
