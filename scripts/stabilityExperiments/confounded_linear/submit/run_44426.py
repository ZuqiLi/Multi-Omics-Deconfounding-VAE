...
np.random.seed(44426)
torch.manual_seed(44426)
L.seed_everything(44426, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_44426" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
