...
from models.cXVAE import cXVAE_inputEmbed # cXVAE_input, cXVAE_inputEmbed, cXVAE_embed, cXVAE_fusedEmbed
...
np.random.seed(38056)
torch.manual_seed(38056)
L.seed_everything(38056, workers=True)
...
##             Training procedure              ##
#################################################
modelname = 'confounded_linear/stability/cXVAE_inputEmbed/run_38056'
maxEpochs = 150
