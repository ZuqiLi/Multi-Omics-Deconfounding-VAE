...
np.random.seed(8983)
torch.manual_seed(8983)
L.seed_everything(8983, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_8983" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
