...
np.random.seed(17082)
torch.manual_seed(17082)
L.seed_everything(17082, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_17082" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
