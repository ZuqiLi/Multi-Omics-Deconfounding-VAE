...
np.random.seed(74228)
torch.manual_seed(74228)
L.seed_everything(74228, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_74228" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
