...
np.random.seed(31630)
torch.manual_seed(31630)
L.seed_everything(31630, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_31630" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
