...
np.random.seed(36505)
torch.manual_seed(36505)
L.seed_everything(36505, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_36505" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
