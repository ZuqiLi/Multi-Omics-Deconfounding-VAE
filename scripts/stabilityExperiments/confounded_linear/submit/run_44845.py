...
np.random.seed(44845)
torch.manual_seed(44845)
L.seed_everything(44845, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_44845" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
