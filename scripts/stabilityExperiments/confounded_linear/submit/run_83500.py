...
np.random.seed(83500)
torch.manual_seed(83500)
L.seed_everything(83500, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_83500" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
