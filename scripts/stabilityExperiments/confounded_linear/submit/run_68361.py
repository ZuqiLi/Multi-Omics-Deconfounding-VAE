...
np.random.seed(68361)
torch.manual_seed(68361)
L.seed_everything(68361, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_68361" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
