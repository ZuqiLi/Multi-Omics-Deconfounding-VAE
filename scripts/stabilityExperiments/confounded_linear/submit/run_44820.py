...
np.random.seed(44820)
torch.manual_seed(44820)
L.seed_everything(44820, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_44820" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
