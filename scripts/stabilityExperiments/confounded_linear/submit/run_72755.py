...
np.random.seed(72755)
torch.manual_seed(72755)
L.seed_everything(72755, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_72755" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
