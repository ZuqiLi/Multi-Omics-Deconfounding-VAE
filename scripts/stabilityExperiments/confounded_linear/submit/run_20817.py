...
np.random.seed(20817)
torch.manual_seed(20817)
L.seed_everything(20817, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_20817" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
