...
np.random.seed(86803)
torch.manual_seed(86803)
L.seed_everything(86803, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_86803" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
