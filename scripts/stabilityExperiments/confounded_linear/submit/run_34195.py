...
np.random.seed(34195)
torch.manual_seed(34195)
L.seed_everything(34195, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_34195" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
