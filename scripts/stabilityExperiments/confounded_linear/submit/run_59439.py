...
np.random.seed(59439)
torch.manual_seed(59439)
L.seed_everything(59439, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_59439" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
