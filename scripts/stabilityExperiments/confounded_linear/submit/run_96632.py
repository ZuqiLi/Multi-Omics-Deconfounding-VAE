...
np.random.seed(96632)
torch.manual_seed(96632)
L.seed_everything(96632, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_96632" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
