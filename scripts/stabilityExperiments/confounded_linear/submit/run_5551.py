...
np.random.seed(5551)
torch.manual_seed(5551)
L.seed_everything(5551, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_5551" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
