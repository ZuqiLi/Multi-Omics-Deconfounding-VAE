...
np.random.seed(5845)
torch.manual_seed(5845)
L.seed_everything(5845, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_5845" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
