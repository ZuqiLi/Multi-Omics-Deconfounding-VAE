...
np.random.seed(46427)
torch.manual_seed(46427)
L.seed_everything(46427, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_46427" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
