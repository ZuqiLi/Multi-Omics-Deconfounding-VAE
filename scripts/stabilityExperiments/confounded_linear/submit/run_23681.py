...
np.random.seed(23681)
torch.manual_seed(23681)
L.seed_everything(23681, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_23681" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
