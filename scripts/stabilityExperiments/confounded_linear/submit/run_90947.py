...
np.random.seed(90947)
torch.manual_seed(90947)
L.seed_everything(90947, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_90947" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
