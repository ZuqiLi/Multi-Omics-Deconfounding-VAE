...
np.random.seed(27220)
torch.manual_seed(27220)
L.seed_everything(27220, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_27220" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
