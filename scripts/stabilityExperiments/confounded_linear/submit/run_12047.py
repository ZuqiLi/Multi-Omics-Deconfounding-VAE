...
np.random.seed(12047)
torch.manual_seed(12047)
L.seed_everything(12047, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_12047" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
