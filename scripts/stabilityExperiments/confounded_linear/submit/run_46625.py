...
np.random.seed(46625)
torch.manual_seed(46625)
L.seed_everything(46625, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_46625" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
