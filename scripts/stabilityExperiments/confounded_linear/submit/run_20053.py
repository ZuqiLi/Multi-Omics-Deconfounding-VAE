...
np.random.seed(20053)
torch.manual_seed(20053)
L.seed_everything(20053, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_20053" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
