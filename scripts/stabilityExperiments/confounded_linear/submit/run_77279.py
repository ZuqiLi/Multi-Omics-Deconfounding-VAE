...
np.random.seed(77279)
torch.manual_seed(77279)
L.seed_everything(77279, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_linear/stability/XVAE_scGAN_multiclass/run_77279" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
