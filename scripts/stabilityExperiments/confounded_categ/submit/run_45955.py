...
np.random.seed(45955)
torch.manual_seed(45955)
L.seed_everything(45955, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_45955" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
