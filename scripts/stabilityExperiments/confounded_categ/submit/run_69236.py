...
np.random.seed(69236)
torch.manual_seed(69236)
L.seed_everything(69236, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_69236" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
