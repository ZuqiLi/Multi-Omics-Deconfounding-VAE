...
np.random.seed(52100)
torch.manual_seed(52100)
L.seed_everything(52100, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_52100" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
