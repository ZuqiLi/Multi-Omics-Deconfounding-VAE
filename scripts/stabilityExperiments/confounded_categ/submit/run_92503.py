...
np.random.seed(92503)
torch.manual_seed(92503)
L.seed_everything(92503, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_92503" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
