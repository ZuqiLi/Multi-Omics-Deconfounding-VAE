...
np.random.seed(28458)
torch.manual_seed(28458)
L.seed_everything(28458, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_28458" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
