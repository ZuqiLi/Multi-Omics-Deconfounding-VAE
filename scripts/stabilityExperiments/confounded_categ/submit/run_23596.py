...
from models.adversarial_XVAE_multiclass import XVAE, advNet, XVAE_scGAN_multiclass ##XVAE_adversarial_multiclass



''' Set seeds for replicability  -Ensure that all operations are deterministic on GPU (if used) for reproducibility '''
np.random.seed(23596)
torch.manual_seed(23596)
L.seed_everything(23596, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_23596" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
