...
np.random.seed(90365)
torch.manual_seed(90365)
L.seed_everything(90365, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_90365" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
