...
np.random.seed(98560)
torch.manual_seed(98560)
L.seed_everything(98560, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_98560" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
