...
np.random.seed(54435)
torch.manual_seed(54435)
L.seed_everything(54435, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_54435" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
