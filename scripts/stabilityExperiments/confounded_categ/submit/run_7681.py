...
np.random.seed(7681)
torch.manual_seed(7681)
L.seed_everything(7681, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_7681" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
