...
np.random.seed(19627)
torch.manual_seed(19627)
L.seed_everything(19627, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_19627" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
