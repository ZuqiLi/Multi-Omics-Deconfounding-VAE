...
np.random.seed(42878)
torch.manual_seed(42878)
L.seed_everything(42878, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_42878" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
