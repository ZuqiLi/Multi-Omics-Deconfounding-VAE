...
np.random.seed(40180)
torch.manual_seed(40180)
L.seed_everything(40180, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_40180" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
