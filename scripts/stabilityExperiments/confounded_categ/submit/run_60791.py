...
np.random.seed(60791)
torch.manual_seed(60791)
L.seed_everything(60791, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_60791" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
