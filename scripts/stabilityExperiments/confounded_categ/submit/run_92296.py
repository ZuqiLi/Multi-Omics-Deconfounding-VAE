...
np.random.seed(92296)
torch.manual_seed(92296)
L.seed_everything(92296, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_92296" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
