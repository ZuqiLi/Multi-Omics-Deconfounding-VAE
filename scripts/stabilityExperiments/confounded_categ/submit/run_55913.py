...
np.random.seed(55913)
torch.manual_seed(55913)
L.seed_everything(55913, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_categ/stability/XVAE_scGAN_multiclass/run_55913" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
