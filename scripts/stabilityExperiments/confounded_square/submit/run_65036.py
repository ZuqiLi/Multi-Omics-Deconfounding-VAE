...
np.random.seed(65036)
torch.manual_seed(65036)
L.seed_everything(65036, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_65036" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
