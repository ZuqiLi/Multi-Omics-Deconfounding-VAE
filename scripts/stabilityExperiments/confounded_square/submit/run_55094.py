...
np.random.seed(55094)
torch.manual_seed(55094)
L.seed_everything(55094, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_55094" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
