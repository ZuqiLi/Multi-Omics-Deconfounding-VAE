...
np.random.seed(11192)
torch.manual_seed(11192)
L.seed_everything(11192, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_11192" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
