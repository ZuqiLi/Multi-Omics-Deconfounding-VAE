...
np.random.seed(36831)
torch.manual_seed(36831)
L.seed_everything(36831, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_36831" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
