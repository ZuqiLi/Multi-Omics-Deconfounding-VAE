...
np.random.seed(18647)
torch.manual_seed(18647)
L.seed_everything(18647, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_18647" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
