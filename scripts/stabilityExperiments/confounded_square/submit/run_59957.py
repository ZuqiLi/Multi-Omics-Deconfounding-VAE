...
np.random.seed(59957)
torch.manual_seed(59957)
L.seed_everything(59957, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_59957" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
