...
np.random.seed(41243)
torch.manual_seed(41243)
L.seed_everything(41243, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_41243" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
