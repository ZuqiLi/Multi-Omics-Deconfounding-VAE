...
np.random.seed(67697)
torch.manual_seed(67697)
L.seed_everything(67697, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_67697" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
