...
np.random.seed(20759)
torch.manual_seed(20759)
L.seed_everything(20759, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_20759" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
