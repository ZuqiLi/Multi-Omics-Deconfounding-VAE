...
np.random.seed(40893)
torch.manual_seed(40893)
L.seed_everything(40893, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_40893" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
