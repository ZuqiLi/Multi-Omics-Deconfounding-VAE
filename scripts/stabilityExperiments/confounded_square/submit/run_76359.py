...
np.random.seed(76359)
torch.manual_seed(76359)
L.seed_everything(76359, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_76359" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
