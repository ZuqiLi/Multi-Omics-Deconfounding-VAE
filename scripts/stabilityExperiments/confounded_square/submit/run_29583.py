...
np.random.seed(29583)
torch.manual_seed(29583)
L.seed_everything(29583, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_29583" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
