...
np.random.seed(46159)
torch.manual_seed(46159)
L.seed_everything(46159, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_46159" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
