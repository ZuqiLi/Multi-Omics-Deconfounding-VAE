...
np.random.seed(83611)
torch.manual_seed(83611)
L.seed_everything(83611, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_83611" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
