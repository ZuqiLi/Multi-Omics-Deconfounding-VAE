...
np.random.seed(92757)
torch.manual_seed(92757)
L.seed_everything(92757, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_92757" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
