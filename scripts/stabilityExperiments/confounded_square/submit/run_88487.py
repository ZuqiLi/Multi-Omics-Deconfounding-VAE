...
np.random.seed(88487)
torch.manual_seed(88487)
L.seed_everything(88487, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_88487" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
