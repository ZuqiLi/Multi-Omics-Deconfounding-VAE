...
np.random.seed(66183)
torch.manual_seed(66183)
L.seed_everything(66183, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_66183" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
