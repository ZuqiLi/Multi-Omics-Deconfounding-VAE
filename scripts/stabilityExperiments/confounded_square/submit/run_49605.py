...
np.random.seed(49605)
torch.manual_seed(49605)
L.seed_everything(49605, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_49605" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
