...
np.random.seed(77227)
torch.manual_seed(77227)
L.seed_everything(77227, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_77227" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
