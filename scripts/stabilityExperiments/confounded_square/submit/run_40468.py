...
np.random.seed(40468)
torch.manual_seed(40468)
L.seed_everything(40468, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_40468" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
