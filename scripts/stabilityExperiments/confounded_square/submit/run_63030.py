...
np.random.seed(63030)
torch.manual_seed(63030)
L.seed_everything(63030, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_63030" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
