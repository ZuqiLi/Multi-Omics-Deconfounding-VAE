...
np.random.seed(73328)
torch.manual_seed(73328)
L.seed_everything(73328, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_73328" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
