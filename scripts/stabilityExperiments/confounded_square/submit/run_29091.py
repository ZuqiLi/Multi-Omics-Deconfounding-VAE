...
np.random.seed(29091)
torch.manual_seed(29091)
L.seed_everything(29091, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_29091" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
