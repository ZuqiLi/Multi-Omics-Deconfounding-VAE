...
np.random.seed(26481)
torch.manual_seed(26481)
L.seed_everything(26481, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_26481" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
