...
np.random.seed(90727)
torch.manual_seed(90727)
L.seed_everything(90727, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_90727" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
