...
np.random.seed(29839)
torch.manual_seed(29839)
L.seed_everything(29839, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_29839" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
