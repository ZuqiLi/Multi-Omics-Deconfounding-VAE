...
np.random.seed(5077)
torch.manual_seed(5077)
L.seed_everything(5077, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_5077" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
