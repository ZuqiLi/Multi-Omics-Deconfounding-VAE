...
np.random.seed(8950)
torch.manual_seed(8950)
L.seed_everything(8950, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_8950" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
