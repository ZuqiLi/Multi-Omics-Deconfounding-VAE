...
np.random.seed(12582)
torch.manual_seed(12582)
L.seed_everything(12582, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_12582" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
