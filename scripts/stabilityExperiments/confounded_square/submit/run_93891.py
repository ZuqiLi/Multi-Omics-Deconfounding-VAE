...
np.random.seed(93891)
torch.manual_seed(93891)
L.seed_everything(93891, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_93891" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
