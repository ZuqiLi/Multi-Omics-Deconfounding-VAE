...
np.random.seed(35970)
torch.manual_seed(35970)
L.seed_everything(35970, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_35970" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
