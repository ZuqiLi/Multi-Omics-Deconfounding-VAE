...
np.random.seed(56731)
torch.manual_seed(56731)
L.seed_everything(56731, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_56731" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
