...
np.random.seed(34661)
torch.manual_seed(34661)
L.seed_everything(34661, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_34661" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
