...
np.random.seed(7557)
torch.manual_seed(7557)
L.seed_everything(7557, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_7557" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
