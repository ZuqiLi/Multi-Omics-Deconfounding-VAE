...
np.random.seed(82190)
torch.manual_seed(82190)
L.seed_everything(82190, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_82190" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
