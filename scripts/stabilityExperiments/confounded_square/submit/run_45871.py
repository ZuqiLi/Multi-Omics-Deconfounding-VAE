...
np.random.seed(45871)
torch.manual_seed(45871)
L.seed_everything(45871, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_45871" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
