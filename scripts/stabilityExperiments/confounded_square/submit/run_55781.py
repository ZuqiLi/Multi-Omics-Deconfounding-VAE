...
np.random.seed(55781)
torch.manual_seed(55781)
L.seed_everything(55781, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_55781" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
