...
np.random.seed(91832)
torch.manual_seed(91832)
L.seed_everything(91832, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_91832" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
