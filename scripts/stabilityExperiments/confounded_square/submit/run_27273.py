...
np.random.seed(27273)
torch.manual_seed(27273)
L.seed_everything(27273, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_27273" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
