...
np.random.seed(5535)
torch.manual_seed(5535)
L.seed_everything(5535, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_5535" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
