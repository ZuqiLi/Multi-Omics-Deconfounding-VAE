...
np.random.seed(24327)
torch.manual_seed(24327)
L.seed_everything(24327, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_24327" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
