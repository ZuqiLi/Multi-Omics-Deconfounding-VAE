...
np.random.seed(45800)
torch.manual_seed(45800)
L.seed_everything(45800, workers=True)
...
##             Training procedure              ##
#################################################
modelname = "confounded_square/stability/XVAE_scGAN_multiclass/run_45800" #"confounded_categ2/XVAE_advTraining/XVAE_advTraining_multiclass"
ls = 50
