...
class XVAE_w_advNet(L.LightningModule):
    ...
    def on_test_epoch_end(self):
        ...
        ### Still implement
        #       - loss on test set (each one)
        #       - everything from xvae (clustering, recon,...)
        #       - mse age regression for evaluating advNet (if it gets much worse, it means we have to do ping pong trg)
        return
