...
class cXVAE_input(L.LightningModule):
    def __init__(self,
                 input_size: list[int],
        ...
        self.enc_hidden_x1 = seqBlock(self.input_size[0] + self.cov_size, self.hidden_ind_size[0], p=self.dropout)      ### add covariates in first layer here
        self.enc_hidden_x2 = seqBlock(self.input_size[1] + self.cov_size, self.hidden_ind_size[1], p=self.dropout)      ### add covariates in first layer here
    ...
    def encode(self, x1, x2, cov):
        ...
        x1_hidden = self.enc_hidden_x1(torch.cat((x1, cov), dim=1))
        x2_hidden = self.enc_hidden_x2(torch.cat((x2, cov), dim=1))
...
class cXVAE_inputEmbed(L.LightningModule):
    def __init__(self,
                 input_size: list[int],
                 hidden_ind_size: list[int], 
                 hidden_fused_size: list[int],
...
class cXVAE_embed(L.LightningModule):
    def __init__(self,
                 input_size: list[int],
                 hidden_ind_size: list[int], 
                 hidden_fused_size: list[int],
