...
class XVAE_scGAN(L.LightningModule):
    def __init__(self, 
                 PATH_xvae_ckpt,
                 PATH_advNet_ckpt,
                 labels_onehot,
        ...
        self.encoderOnly = torch.nn.Sequential(*self.xvae_pre.encoder_x1_fc,
                            *self.xvae_pre.encoder_x2_fc, 
                            *self.xvae_pre.encoder_fuse)
    ...
    def configure_optimizers(self):
        ...
        optimizerVAE = optim.Adam(self.xvae_pre.parameters(), lr=1e-3, betas=(0.9, 0.999), eps=1e-08, amsgrad=False, weight_decay=0)
